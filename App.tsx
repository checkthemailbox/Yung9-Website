...
const songsData: Song[] = [
  ...
  },
  {
    ...
    audioSnippetUrl: 'https://res.cloudinary.com/dxpexhv42/video/upload/v1748738875/GIMME_DA_CART_v5_sb0hdo.wav', 
  },
];
...
const App: React.FC = () => {
  ...
  return (
    <> 
      {!isVaultModeActive && <GreenRainEffect />}
      <div 
        className={`page-container min-h-screen text-white selection:bg-purple-500 selection:text-white flex flex-col relative z-10 overflow-x-hidden ${
          isPageScrolling ? 'scrolling' : ''
        }`}
      >
        ...
        <div className={`flex-grow main-content-blur-target`}>
          {isVaultModeActive ? (
            <VaultContent 
              song={vaultSongData} 
              ...
              <main className="container mx-auto px-4 py-10 sm:py-16">
                ...
                {centeredSong && (
                  <div className="flex justify-center mt-12 sm:mt-16">
                    ...
                    >
                      <h3 className="text-2xl sm:text-3xl font-bold text-yellow-400 mb-4 tracking-tight text-center motion-safe:animate-pulse-glow-yellow motion-reduce:animate-none">
        ...
        <footer 
          ref={footerRef}
          key={`footer-section-${isVaultModeActive}`}
          className={`footer-blur-target text-center py-8 text-sm section-base-styles ${
